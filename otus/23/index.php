...
$APPLICATION->SetTitle('23. DADATA');
...
$token = "d1ced3f0455d0e5e9b460fef0c8c53a3fdc70159";
$secret = "6342fab5435816da8bc141eb2ba0f8c10d62b3c0";
...
// echo 'COUNT_RECURSIVE - '.count($result, COUNT_RECURSIVE).'</br>';
// echo 'COUNT - '.count($result).'</br>';

//echo 'vv - '.$result[0][0]['value'].'</br>';


foreach ($result as $arItem)  {
echo 'vrrv - '.$arItem[0]['value'].'</br>';    
    foreach ($arItem as $res)  {
        //echo 'COUNT v - '.count($res).'</br>';
        foreach ($res as $key => $revalus)  {
//            echo $key.' : '.$revalus.'</br>';
                if ($key=='value'){
                    echo ' name - '.$revalus; 
                }
