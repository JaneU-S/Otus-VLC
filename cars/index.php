...
// $arSelect = ['ID', 'NAME', 'CODE', 'PROPERTY_MODEL', 'PROPERTY_ENGINE_VALUE'];
...
// $res = \Bitrix\Iblock\Elements\ElementCarsTable::update(36, array(
//     'NAME' => 'TEST 777',
// ));


// удаление записи из БД
// $res = \Bitrix\Iblock\Elements\ElementCarsTable::delete(43);
// pr($res);
